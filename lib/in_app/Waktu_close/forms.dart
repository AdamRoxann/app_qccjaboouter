...
class WaktuCloseForm extends StatefulWidget {
  @override
  _WaktuCloseFormState createState() => _WaktuCloseFormState();
}

class _WaktuCloseFormState extends State<WaktuCloseForm> {
  String _mySelection;
