...
import 'package:qccjaboouter/admin/admin_forms.dart';
...
class AdminJenisPage extends StatefulWidget {
  final String id;
  AdminJenisPage(this.id);
  @override
  _AdminJenisPageState createState() => _AdminJenisPageState();
}

class _AdminJenisPageState extends State<AdminJenisPage> {
  List data = [
    {"title": "Waktu Close"},
    {"title": "Kondisi Site"},
    {"title": "Dihapuskan"}
                      ...
                      child: FlatButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AdminForms(widget.id.toString(), "Waktu Close"),
                            ),
                          );
                          // check();
                        },
